...
<ul>
  <li>1. حمل ملف الـ Excel المسمى Business Cards.csv من هنا <a href="https://raw.githubusercontent.com/heshameraqi/heshameraqi.github.io/master/bussiness-cards-nahdetmisr/data/Business%20Cards.csv" download="logo.png">Download SO Logo</a> و أفتحه باستخدام برنامج Notepad و أضف بيانات جميع الموظفين المُراد استخراج كارت شخصي إلكتروني لهم بهذا الملف. بيانات الموظف تكون مفصولة بحرف ;
