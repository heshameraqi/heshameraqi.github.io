...
1. Generate the QR code that will be printed with on the physical card:
	...
	2. Add this link/URL: https://raw.githack.com/heshameraqi/bussiness-cards-nahdetmisr/main/card.html?employee_number=5 and generate the QR to be printed (Please note to change 5.html according to the employee number)
